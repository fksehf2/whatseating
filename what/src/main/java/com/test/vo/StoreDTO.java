...
public class StoreDTO {
	   ...
	   private String ST_ADDRESSNO;
	   private String ST_ADDRESSBASIC;
	   private String ST_ADDRESSDETAIL;
	   private String ST_ADDRESSEXTRA;
	   private String ST_PHNO;
	   private String ST_STARTTIME;
	   private String ST_ENDTIME;
	   private String ST_CONTENT;
	   private int ST_AVGSCORE;
